...
macro_rules! error {
    ...
    (logger: $logger:expr, target: $target:expr, $($arg:tt)+) => ({
        $crate::log!(logger: $crate::__log_logger!($logger), target: $target, log::Level::Error, $($arg)+)
    });

    // error!(logger: my_logger, key1 = 42, key2 = true; "a {} event", "log")
    // error!(logger: my_logger, "a {} event", "log")
    (logger: $logger:expr, $($arg:tt)+) => ({
        $crate::log!(logger: $crate::__log_logger!($logger), log::Level::Error, $($arg)+)
    });
...
macro_rules! warn {
    ...
    (logger: $logger:expr, target: $target:expr, $($arg:tt)+) => ({
        $crate::log!(logger: $crate::__log_logger!($logger), target: $target, log::Level::Warn, $($arg)+)
    });

    // warn!(logger: my_logger, key1 = 42, key2 = true; "a {} event", "log")
    // warn!(logger: my_logger, "a {} event", "log")
    (logger: $logger:expr, $($arg:tt)+) => ({
        $crate::log!(logger: $crate::__log_logger!($logger), log::Level::Warn, $($arg)+)
    });
...
macro_rules! info {
    ...
    (logger: $logger:expr, target: $target:expr, $($arg:tt)+) => ({
        $crate::log!(logger: $crate::__log_logger!($logger), target: $target, log::Level::Info, $($arg)+)
    });

    // info!(logger: my_logger, key1 = 42, key2 = true; "a {} event", "log")
    // info!(logger: my_logger, "a {} event", "log")
    (logger: $logger:expr, $($arg:tt)+) => ({
        $crate::log!(logger: $crate::__log_logger!($logger), log::Level::Info, $($arg)+)
    });
...
macro_rules! debug {
    ...
    (logger: $logger:expr, target: $target:expr, $($arg:tt)+) => ({
        $crate::log!(logger: $crate::__log_logger!($logger), target: $target, log::Level::Debug, $($arg)+)
    });

    // debug!(logger: my_logger, key1 = 42, key2 = true; "a {} event", "log")
    // debug!(logger: my_logger, "a {} event", "log")
    (logger: $logger:expr, $($arg:tt)+) => ({
        $crate::log!(logger: $crate::__log_logger!($logger), log::Level::Debug, $($arg)+)
    });
...
macro_rules! trace {
    ...
    (logger: $logger:expr, target: $target:expr, $($arg:tt)+) => ({
        $crate::log!(logger: $crate::__log_logger!($logger), target: $target, log::Level::Trace, $($arg)+)
    });

    // trace!(logger: my_logger, key1 = 42, key2 = true; "a {} event", "log")
    // trace!(logger: my_logger, "a {} event", "log")
    (logger: $logger:expr, $($arg:tt)+) => ({
        $crate::log!(logger: $crate::__log_logger!($logger), log::Level::Trace, $($arg)+)
    });
...
macro_rules! log_enabled {
    ...
    (logger: $logger:expr, $lvl:expr) => ({
        $crate::__log_enabled!(logger: $crate::__log_logger!($logger), target: log::__private_api::module_path!(), $lvl)
    });
